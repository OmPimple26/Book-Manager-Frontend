...
export default function App() {
  ...
  // Fetch all books
  useEffect(() => {
      fetch("https://book-manager-backend-80l6.onrender.com/api/books")
      .then((res) => res.json())
  ...
  const addBook = async () => {
    ...
    const res = await fetch("https://book-manager-backend-80l6.onrender.com/api/books", {
      method: "POST",
  ...
  const saveEdit = async (id) => {
    ...
    const res = await fetch(`https://book-manager-backend-80l6.onrender.com/api/books/${id}`, {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
  ...
  const deleteBook = async (id) => {
    await fetch(`https://book-manager-backend-80l6.onrender.com/api/books/${id}`, { method: "DELETE" });
